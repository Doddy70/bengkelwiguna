        ...
        <div className="max-w-screen-xl mx-auto px-3 sm:px-6 md:px-14 lg:px-14 xl:px-18 2xl:px-3">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative h-64 rounded-2xl overflow-hidden bg-gradient-to-br from-[#224297] to-[#050b14] flex items-center justify-center">
                <span className="text-6xl">🏭</span>
              </div>
              <div className="relative h-64 rounded-2xl overflow-hidden bg-gradient-to-br from-[#ffd900] to-[#ffb800] flex items-center justify-center">
                <span className="text-6xl">🔧</span>
              </div>
              <div className="relative h-64 rounded-2xl overflow-hidden bg-gradient-to-br from-[#224297] to-[#050b14] col-span-2 flex flex-col items-center justify-center">
