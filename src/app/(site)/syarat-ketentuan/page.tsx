// app/(site)/syarat-ketentuan/page.tsx
          ...
          <div className="lg:w-8/12 mx-auto">
            ...
            <footer className="mt-16 pt-8 border-t bg-gray-50 p-6 rounded-lg">
                ...
                <div>
                    ...
                    <Link href="mailto:info@bengkelwiguna.com" className="text-blue-600 hover:underline">
                    info@bengkelwiguna.com
                    </Link>
                </div>
                <div>
                    <p className="font-semibold mb-1">Telepon:</p>
                    <Link href="tel:087817773888" className="text-blue-600 hover:underline">
                    0878-1777-3888
                    </Link>
                </div>
                </div>
