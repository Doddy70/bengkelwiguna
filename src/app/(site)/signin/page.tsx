...
export default function LoginPage() {
    return (
        <div className="auth-wrap min-h-screen flex items-center justify-center relative lg:pt-24 pt-16 font-dm">
            {/* Background image on the right for lg screens */}
            <div className="absolute top-0 right-0 w-1/2 h-[100vh] bg-auth-image-one bg-cover bg-right hidden xl:flex">
                <div className="absolute inset-0 bg-black/20" />
            </div>

            <div className="max-w-screen-xl w-full px-3 sm:px-6 md:px-14 lg:px-14 xl:px-18 2xl:px-3">
                <div className="login-wrap w-full flex justify-start items-center">
                    <div className="xl:w-1/3 md:w-2/5 w-full py-5 md:py-0 lg:pl-8">
                            ...
                            <form className="mt-5 space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="form-input w-full px-3 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary"
                                    />
                                </div>
                                ...
                                <div className="flex justify-center gap-3 mt-4">
                                    ...
                                    <button className="w-14 h-14 bg-gray-100 border border-gray-200 rounded-full flex items-center justify-center">
                                        <svg
                                            ...
                                            height="28"
                                            fill="currentColor"
                                            className="bi bi-google text-red-600"
                                            viewBox="0 0 16 16"
                                        >
                                    ...
                                    <button className="w-14 h-14 bg-gray-100 border border-gray-200 rounded-full flex items-center justify-center">
                                        <svg
                                            ...
                                            height="28"
                                            fill="currentColor"
                                            className="bi bi-gitlab text-gray-800"
                                            viewBox="0 0 16 16"
                                        >
