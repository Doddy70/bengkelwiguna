...
export default function HeroOne() {
    return (
        <div className="banner-wrap lg:pb-24 pb-12 font-dm bg-home-one-gradient-banner relative pt-24">
            <div className="max-w-screen-xl mx-auto boxed-layout-gap pb-0">
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-10 lg:pt-10 relative z-10">
                    ...
                    <div className="w-full items-center flex h-full xl:pr-8">
                        <div className="flex flex-col ">
                            {/* Badge */}
                            <div>
                                <span className="inline-block py-2 px-3 brand-rounded border border-gray-200 bg-white text-sm text-brand-blue font-medium aos-init aos-animate" data-aos="fade-up" data-aos-duration="200">
                                    Online program is now available
                                </span>
                            </div>

                            {/* Heading */}
                            <h1 className="text-gray-900 font-semibold xl:text-[80px] lg:text-6xl text-5xl mt-2 mb-3 tracking-tighter aos-init aos-animate" data-aos="fade-up" data-aos-duration="400"> Empowering <span className="text-brand-blue">Superior</span>  results  by thinking </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-8 pb-3">
                                <Button href="/pricing" label="Start trial for 14 days" bgColor="bg-brand-blue" textColor="text-white" padding="py-4 px-6" />
                    ...
                    <div className="w-full">
                        <div className="relative rounded-xl lg:overflow-visible overflow-hidden aos-init aos-animate" data-aos="fade-up" data-aos-duration="600">
                            {/* Main Image */}
                            <Image src="/images/right-banner-bg.svg" alt="banner" decoding="async" loading="eager" width={637} height={721} className="w-full rounded-xl" priority />
