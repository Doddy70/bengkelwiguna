...
export default function Footer({ layout = "default", foretextColor = "text-white", logo = "/images/logo/logo.png", borderColor = "border-gray-800", bgColor = "bg-gray-900", foreColor = "bg-blue-600", iconbgColor = "bg-gray-800" }: FooterProps) {
                ...
                {layout === "default" || layout === "light" ? (
                        ...
                        <div className="w-full 2xl:w-3/6 xl:w-2/3 lg:w-2/3">
                            <div className="flex flex-wrap gap-y-3">
                                ...
                                <div className="flex flex-row gap-3 items-center w-full md:w-1/2">
                                    ...
                                    <div>
                                        <p className={`text-2xl font-semibold mb-0 ${layout === "light" ? "text-gray-900" : "text-white"}`}>+62 878-1777-3888</p>
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6 footer-wrap-top lg:py-14 py-6">
                        <div className="flex flex-row gap-3 items-center w-full">
                            ...
                            <div>
                                <p className="text-2xl font-semibold mb-0">+62 878-1777-3888</p>
                                <p className="text-base font-medium text-gray-400">
                                    Speak with our team
                                </p>
                            </div>
                        ...
                        <div className="flex flex-row gap-3 items-center w-full">
                            ...
                            <div>
                                <p className="text-2xl font-semibold mb-0">Depok, Jawa Barat</p>
                    ...
                    <div className="flex flex-wrap gap-y-4 footer-wrap-top lg:py-14 py-6">
                        ...
                        <div className="w-full xl:w-1/3">
                            <div className="flex flex-col sm:flex-row gap-3 mt-2 mb-4">
                                <label htmlFor="newsletter-email-elegant" className="sr-only">Alamat Email untuk Newsletter</label>
                                <input
                                    id="newsletter-email-elegant"
                                    type="email"
                            ...
                            <p className={`mb-5 text-gray-700 font-medium`}>
                                Dapatkan info terbaru dan tips otomotif dari kami.
                            </p>
                        </div>
                    </div>
                ) : (
                    ...
                    layout === "elegant" ? (
                        <>
                            <div className="flex lg:flex-row flex-col justify-between gap-y-6 lg:py-8 py-6">
                                <div className=""><p className="text-gray-800 text-base font-medium lg:text-start text-center">Bengkel Wiguna © 2026 - All Rights Reserved</p></div>
                        ...
                        <div className="text-center lg:py-7 py-4">
                            <p className="text-gray-400 text-base font-medium py-2">
                                Bengkel Wiguna © 2026 - All Rights Reserved
                            </p>
                        </div>
                    )
                }
