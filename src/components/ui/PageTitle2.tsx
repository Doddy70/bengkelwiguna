...
export default function PageTitle2({
    ...
    return (
        <div className="page-title bg-light-blue-banner lg:pt-12 pt-8 font-dm">
            <div className="max-w-screen-xl mx-auto px-3 sm:px-6 md:px-14 lg:px-14 xl:px-20 2xl:px-24 lg:py-16 py-12">
                {/* title wrapper */}
