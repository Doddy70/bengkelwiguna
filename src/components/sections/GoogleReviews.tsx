...
export default function GoogleReviews() {
  ...
  if (!isLoaded || !SplideComponent || !SplideSlideComponent) {
    return (
      <section className="py-24 bg-transparent dark:bg-transparent overflow-hidden">
        <div className="max-w-screen-xl mx-auto boxed-layout-gap">
          <div className="animate-pulse">
            <div className="h-8 bg-gray-200 dark:bg-gray-700 rounded w-48 mb-4"></div>
            <div className="h-12 bg-gray-200 dark:bg-gray-700 rounded w-96 mb-12"></div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="h-[320px] bg-gray-100 dark:bg-gray-800 rounded-xl"></div>
              ))}
            </div>
          </div>
        </div>
  ...
  return (
    <section id="google-reviews-section" className="py-24 bg-transparent dark:bg-transparent overflow-hidden">
      <div className="max-w-screen-xl mx-auto boxed-layout-gap">

        {/* Header Section */}
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 gap-8">
          <div className="flex flex-col gap-2">
            <span className="text-brand-blue dark:text-brand-blue font-bold uppercase tracking-widest text-sm flex items-center gap-2">
          ...
          <div className="bg-white dark:bg-gray-800 p-5 brand-rounded shadow-sm border border-gray-100 dark:border-gray-700 flex items-center gap-5 w-full lg:w-auto">
            <div className="w-12 h-12 flex-shrink-0">
              <GoogleLogo />
            </div>
            <div className="flex-grow">
              <div className="flex items-center gap-2">
                <span className="text-2xl font-black text-[#1a3567] dark:text-white">{avgRating.toFixed(1)}</span>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mt-1 uppercase tracking-tighter">
        ...
        <div className="w-full pb-12">
          ...
          >
            {reviewsList.map((review, idx) => (
              <Slide key={idx}>
                <div className="bg-white dark:bg-gray-800 brand-rounded p-8 shadow-sm border border-gray-50 dark:border-gray-700 h-[320px] flex flex-col hover:shadow-xl transition-all duration-500">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="flex flex-col">
                      <h4 className="font-bold text-[#1a3567] dark:text-white text-base leading-none mb-1">{review.name}</h4>
                      <span className="text-[11px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-tight">{review.role}</span>
                    </div>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-[11px] text-gray-500 dark:text-gray-400 font-bold">{review.date}</span>
                  </div>

                  {/* Review Body */}
                  <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed font-medium italic line-clamp-4">
                    &quot;{review.text}&quot;
                  </p>
                </div>
              </Slide>
