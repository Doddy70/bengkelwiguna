...
- `references/domain-vs-projection.md` — the layer model that puts shared services at the domain layer and projections (REST / MCP / CLI / UI) above.
- `references/grouping-heuristic.md` — orthogonal: this reference covers "same code path"; that one covers "how many abilities."
