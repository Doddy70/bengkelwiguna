...
const SignupPage: React.FC = () => {
    return (
        <div className="auth-wrap min-h-screen flex items-center justify-center relative lg:pt-24 pt-16">
            ...
            <div className="absolute top-0 right-0 w-1/2 h-[100vh] bg-auth-image-one bg-cover bg-right xl:flex hidden">
            ...
            <div className="max-w-screen-xl w-full px-3 sm:px-6 md:px-14 lg:px-14 xl:px-18 2xl:px-3 font-dm">
                <div className="login-wrap w-full flex justify-start items-center">
                    <div className="xl:w-1/3 md:w-2/5 w-full py-5 md:py-0 lg:ps-8">
