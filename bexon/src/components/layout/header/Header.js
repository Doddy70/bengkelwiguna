...
const Header = ({
	...
	navItems = null, // Add prop for dynamic menu
}) => {
								...
								<div className="header-right-item d-none d-lg-inline-flex">
									...
									{headerType !== 5 ? (
										<div className="header-button">
											<ButtonPrimary text={"Chat Minna"} url={"https://wa.me/6287817773888?text=halo%20mon,%20saya%20ingin%20tanya%20seputar%20servis%20mobil%20saya%20di%20bengkel%20wiguna.%20(web)"} />
										</div>
									) : (
										""
									)}
