					...
					<div className="col-12 col-md-6 col-lg-4">
						...
						>
							...
							<div className="h5-strategy-avatar">
								<Image
									src="/images/strategy/strategy-avatar.png"
									alt="Mekanik profesional melayani pelanggan"
									width={400}
									height={300}
									sizes="(max-width: 768px) 100vw, 400px"
									style={{ borderRadius: '15px', objectFit: 'cover', width: '100%', height: 'auto' }}
								/>
							</div>
					...
					<div className="col-12 col-md-6 col-lg-4">
						...
						>
							...
							<div className="h5-strategy-chart">
								<Image
									src="/images/strategy/strategy-chart.webp"
									alt=""
									width={400}
									height={300}
									sizes="(max-width: 768px) 100vw, 400px"
